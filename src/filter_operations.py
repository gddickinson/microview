    ...
    def gaussianBlur(self):
        if self.parent.window_management.current_window:
            ...
            if ok:
                ...
                self.parent.window_management.current_window.setImage(blurred)
    ...
    def medianFilter(self):
        if self.parent.window_management.current_window:
            ...
            if ok:
                ...
                self.parent.window_management.current_window.setImage(filtered)

    def sobelEdge(self):
        if self.parent.window_management.current_window:
            image = self.parent.window_management.current_window.image
            edges = self.parent.image_processor.sobel_edge(image)
            self.parent.window_management.current_window.setImage(edges)
